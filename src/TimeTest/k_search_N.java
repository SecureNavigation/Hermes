...
public class k_search_N {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Point start = new Point(497);
        start.x = 38;
        start.y = 56;

        Point end = new Point(177);
        end.x = 66;
        end.y = 72;
        ...
        high[0] = new Point(215);
        high[0].x = 64;
        high[0].y = 94;
        high[1] = new Point(52);
        high[1].x = 77;
        high[1].y = 81;
        high[2] = new Point(488);
        high[2].x = 81;
        high[2].y = 67;
        ...
        long[] Sum_search = new long[10];
        long[] Sum_recover = new long[10];
        int[] Sum_recover_len= new int[10];

        for (int group_time = 0; group_time < 10; group_time++) {
