...
import Baselines.GroupBridgeAlwaysNearest;
import Ciper.BGN;
 ...
 * @Version 1.0
 */
public class k_search_baseline_GBAtN {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Point start = new Point(822);
        start.x = 26;
        start.y = 56;

        Point end = new Point(1334);
        end.x = 51;
        end.y = 78;
...
//        end.setC_Y(bgn);
        ...
        low[0] = new Point(1318);
        low[0].x = 10;
        low[0].y = 61;
        low[1] = new Point(1451);
        low[1].x = 20;
        low[1].y = 49;
        low[2] = new Point(1145);
        low[2].x = 13;
        low[2].y = 57;


        Point[] mid = new Point[3];
        mid[0] = new Point(1317);
        mid[0].x = 29;
        mid[0].y = 68;
        mid[1] = new Point(1854);
        mid[1].x = 40;
        mid[1].y = 65;
        mid[2] = new Point(65);
        mid[2].x = 55;
        ...
        high[0] = new Point(1310);
        high[0].x = 59;
        high[0].y = 91;
        high[1] = new Point(80);
        high[1].x = 66;
        high[1].y = 83;
        high[2] = new Point(1601);
        high[2].x = 70;
        high[2].y = 73;
...
//        System.out.println(SN_time);
            ...
            GroupBridgeAlwaysNearest bridgeAlwaysNearest = new GroupBridgeAlwaysNearest();
...
//        strategy_secureNavigation.Secure_SN(bgn, start,end,h,res,all);
                ...
                bridgeAlwaysNearest.Secure_SN_GBAN(bgn, re_start, re_end, next, res, all);
