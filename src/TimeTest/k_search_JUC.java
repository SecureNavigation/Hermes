...
public class k_search_JUC {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Point start = new Point(452);
        start.x = 33;
        start.y = 52;

        Point end = new Point(651);
        end.x = 61;
        end.y = 74;
...
//        end.setC_Y(bgn);
        ...
        high[0] = new Point(207);
        high[0].x = 61;
        high[0].y = 57;
        high[1] = new Point(349);
        high[1].x = 79;
        high[1].y = 67;
        high[2] = new Point(39);
        high[2].x = 69;
...
//        int[] order_low = {4,4,4,4,3,3,3,2,2,1};
//        int[] order_mid = {4,3,2,1,2,3,4,4,3,4};
//        int[] order_high = {1,2,3,4,4,3,2,3,4,4};
//        int k = 9;
//        int[] order_low = {4,4,4,4,4,3,3,3,3,2,2,1,1,0};
//        int[] order_mid = {4,3,2,1,0,1,2,3,4,3,2,3,4,4};
//        int[] order_high = {0,1,2,3,4,4,3,2,1,3,4,4,3,4};
//        int k = 8;
//        int[] order_low = {4,4,4,4,3,3,3,2,2,1};
//        int[] order_mid = {3,2,1,0,1,2,3,3,2,3};
//        int[] order_high = {0,1,2,3,3,2,1,2,3,3};
//        int k = 7;
//        int[] order_low = {4,4,4,3,3,2,2,2,1,1};
//        int[] order_mid = {2,1,0,2,1,1,2,3,3,2};
//        int[] order_high = {0,1,2,1,2,3,2,1,2,3};
//        int k = 6;
//        int[] order_low = {3,3,3,2,2,2,2,1,1,1};
//        int[] order_mid = {2,1,0,2,1,0,3,2,3,1};
//        int[] order_high = {0,1,2,1,2,3,0,2,1,3};
//        int k = 5;
//        int[] order_low = {3,2,1,1,3,1,0,0,0,2};
//        int[] order_mid = {1,1,2,1,0,0,1,2,3,2};
//        int[] order_high = {0,1,1,2,1,3,3,2,1,0};
//        int k = 4;
        int[] order_low = {3,2,2,1,1,1,0,0,0,0};
        int[] order_mid = {0,1,0,2,0,1,3,2,1,0};
        int[] order_high = {0,0,1,0,2,1,0,1,2,3};
        int k = 3;
//        int[] order_low = {2,1,1,0,0,0};
//        int[] order_mid = {0,1,0,2,1,0};
//        int[] order_high = {0,0,1,0,1,2};
//        int k = 2;
...
//                GarbledCricuit.genCircuit();
                Strategy_SecureNavigation_JUC_K3 strategy_secureNavigation_juc = new Strategy_SecureNavigation_JUC_K3();
                strategy_secureNavigation_juc.k = next.length;
                strategy_secureNavigation_juc.last = low_index;
                strategy_secureNavigation_juc.aim = new AtomicInteger(next.length);
                strategy_secureNavigation_juc.index = new AtomicInteger(0);
                strategy_secureNavigation_juc.origin = next.clone();
                strategy_secureNavigation_juc.Secure_SN(bgn, re_start, re_end, next, res);
                strategy_secureNavigation_juc.executorService.shutdown();
                long s_end = System.currentTimeMillis();
//                res.clear();
//                for (int i = 0; i < strategy_secureNavigation_juc.arr.length; i++) {
//                    res.add(strategy_secureNavigation_juc.arr[i]);
//                }
                System.out.println("S: "+(s_end-SN_start));
