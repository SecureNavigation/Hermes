...
import Baselines.GroupBridge_OSCH_A_A;
import Ciper.BGN;
 ...
 * @Version 1.0
 */
public class k_search_baseline_GB_OSCH_A_A {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Point start = new Point(269);
        start.x = 38;
        start.y = 52;

        Point end = new Point(308);
        end.x = 69;
        end.y = 74;
...
//        end.setC_Y(bgn);
        ...
        high[0] = new Point(202);
        high[0].x = 67;
        high[0].y = 85;
        high[1] = new Point(151);
        high[1].x = 79;
        high[1].y = 82;
        high[2] = new Point(147);
        high[2].x = 72;
        high[2].y = 82;
...
//        System.out.println(SN_time);
            ...
            GroupBridge_OSCH_A_A groupBridge_osch_a_a = new GroupBridge_OSCH_A_A();
...
//        strategy_secureNavigation.Secure_SN(bgn, start,end,h,res,all);
                ...
                groupBridge_osch_a_a.Secure_SN_GB_OSCH_A_A(bgn, re_start, re_end, next, res, all);
