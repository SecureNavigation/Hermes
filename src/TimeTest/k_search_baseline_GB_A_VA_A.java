...
import Baselines.GroupBridge_A_VA_A;
import Ciper.BGN;
 ...
 * @Version 1.0
 */
public class k_search_baseline_GB_A_VA_A {
...
//        System.out.println(SN_time);
            ...
            GroupBridge_A_VA_A groupBridge_a_va_a = new GroupBridge_A_VA_A();
...
//        strategy_secureNavigation.Secure_SN(bgn, start,end,h,res,all);
                ...
                groupBridge_a_va_a.Secure_SN_GBAN(bgn, re_start, re_end, next, res, all);
